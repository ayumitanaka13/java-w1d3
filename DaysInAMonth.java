...
// if the user entered month 2 and year 2012, the program should display that February 2012 had 29 days.
...
public class DaysInAMonth {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Please enter a number of the month between 1 - 12");
